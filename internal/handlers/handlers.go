...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	htmlMessage := fmt.Sprintf(`
		...
		Dear %s, <br>
		This is to confirm your reesrvation from %s to %s.
...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	//Security practice everytime you log in or log out make sure to renew the  session token
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		//get all the restrictions for the current roomm
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		//get block map for the session. Loop through the map and if we have an entry in the map
		//that does not exist in the posted data and if the restriction_id > 0, then it is a block we need to remove.
