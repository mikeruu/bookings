...
import (
	...
	"github.com/mikeruu/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) ChooseRoom(w http.ResponseWriter, r *http.Request) {
	...
	//casting as a models.reservation type
...
//PostAvailability renders que majors suite page
...
//Availability handles request for availability and returns JSON
...
//ReservationSummary displays the reseration summary page
...
//BookRoomtakes url parameters and builds a session variable and takes user make res screen
